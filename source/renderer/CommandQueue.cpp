...
bool CommandQueue::IsFenceComplete(uint64_t fenceValue) const { return m_d3d12Fence->GetCompletedValue() >= fenceValue; }
...
ComPtr<ID3D12CommandQueue> CommandQueue::GetQueue() const { return m_d3d12CommandQueue; }